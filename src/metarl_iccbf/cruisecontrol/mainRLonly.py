...
from RLonly import RLCBFcontrol
...
if __name__ == "__main__":
    ...
    trainLoad       = False      # Load a trained model to use in Training
    ...
    training_name = f"RLonly_{arch_str}_{hyper_str}"
